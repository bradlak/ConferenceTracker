...
namespace ConferenceTracker.Services.Mock
{
    public class SessionsService : ISessionsService
    {
        ...
        {
            var data = GetData();
            return Task.FromResult<IEnumerable<Session>>(data);
        }
        ...
        public IList<Session> GetData()
        {
            ...
            sessions.Add(new Session()
            {
                ...
                Speakers = new List<Speaker>() { speakers.GetSpeakerById(2).Result },
                IsFavourite = true
            });
            ...
            sessions.Add(new Session()
            {
                ...
                Speakers = new List<Speaker>(speakers.GetContainingSpeakers(0).Result)
            });
            ...
            sessions.Add(new Session()
            {
                ...
                Speakers = new List<Speaker>(speakers.GetContainingSpeakers(1).Result)
            });
            ...
            sessions.Add(new Session()
            {
                ...
                Speakers = new List<Speaker>(speakers.GetContainingSpeakers(5,6).Result)
            });
            ...
            sessions.Add(new Session()
            {
                ...
                Speakers = new List<Speaker>(speakers.GetContainingSpeakers(3).Result)
            });
            ...
            sessions.Add(new Session()
            {
                ...
                Speakers = new List<Speaker>(speakers.GetContainingSpeakers(3,7).Result)
            });
